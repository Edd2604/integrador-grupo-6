...
public class NacionalController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       String accion = request.getParameter("accion");
        ...
        switch (accion) {   
            case "agregarClienteNacional":
                System.out.println("Agregando Cliente...");
                agregarClienteNacional(request, response);
                break;
                
            case "listarClientesNacionales":
                System.out.println("Listando Clientes Nacioanles");
                listarClientesNacionales(request, response);
                break;
    ...
    private void agregarClienteNacional(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        nuevoCliente.setId_rol_cliente(1); 
     ...
     private void listarClientesNacionales(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        int idRolCliente = 1; 
        ...
        request.getRequestDispatcher("/nacional.jsp").forward(request, response);
    ...
    protected void eliminarCliente(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (idStr != null && !idStr.isEmpty()) {
            try {
                ...
                response.sendRedirect(request.getContextPath() + "/nacionalControlador?accion=listarClientesNacionales" + (paginaActualStr != null ? "&pagina=" + paginaActualStr : "")); 
