...
<html>
    ...
    <body>
        ...
        <div id="main-content" class="transition-all duration-300 sm:ml-64">
            <c:set var="pageTitle" value="Clientes Extranjeros" scope="request"/>
            <%@include file="WEB-INF/jspf/navbar.jspf" %>
            
            <div class=" container mx-auto flex-col items-center justify-center">
                
                <div class="p-8 rounded w-full">
                    <h2 class="text-2xl pl-4 font-semibold mb-14 text-gray-800">Registrar Cliente Extranjero</h2>

                    <form class="max-w-6xl mx-auto" action="extranjeroControlador?accion=agregarClienteExtranjero" method="POST">
                            ...
                            <c:forEach var="cliente" items="${clientes}">
                                <tr class="bg-white border-b border-gray-300 hover:bg-gray-100 hover:text-neutral-900 transition duration-700">
                                    ...
                                    <td class="py-4 flex gap-6 items-center justify-center">
                                        <button type="button" class="inline-flex items-center justify-center w-8 h-8 rounded-md bg-blue-100 text-blue-600 hover:bg-blue-200 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-colors duration-200 btn-actualizar-cliente-extranjero" data-id="${cliente.id_cliente}">
                                        ...
                                        <a href="extranjeroControlador?accion=eliminarCliente&id=${cliente.id_cliente}&pagina=${paginaActual}" class="inline-flex items-center justify-center w-8 h-8 rounded-md bg-red-100 text-red-600 hover:bg-red-200 focus:outline-none focus:ring-2 focus:ring-red-500 transition-colors duration-200">
                            ...
                            <c:forEach var="i" begin="1" end="${totalPaginas}">
                                <c:choose>
                                    ...
                                    <c:otherwise>
                                        ...
                                        <a href="extranjeroControlador?accion=listarClientesExtranjeros&pagina=${i}" class="px-3 py-2 text-blue-500 hover:text-blue-700 bg-white border border-gray-300 rounded mr-2">${i}</a>
                                    </c:otherwise>
                                </c:choose>
                            </c:forEach>
                        </c:if>
            ...
            <div id="modal-modificar-cliente-extranjero" tabindex="-1" aria-hidden="true"
                   ...
                   <div class="relative bg-white rounded-lg shadow-sm">
                       <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t border-gray-200">
                           ...
                           <button type="button"
                                   ...
                                   onclick="document.getElementById('modal-modificar-cliente-extranjero').classList.add('hidden')">
                       ...
                       <form class="p-4 md:p-5" id="formulario-modificar-cliente-extranjero">
                           <input type="hidden" id="id_cliente_extranjero_modal" name="id_cliente" />
                           <div class="grid gap-4 mb-4">
                               <div>
                                   <label for="nombre_extranjero_modal" class="block mb-2 text-sm font-medium text-gray-900">Nombre</label>
                                   <input type="text" id="nombre_extranjero_modal" name="nombre" placeholder="Nombre" required
                                          class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" />
                               </div>
                               <div>
                                   <label for="apellido_extranjero_modal" class="block mb-2 text-sm font-medium text-gray-900">Apellido</label>
                                   <input type="text" id="apellido_extranjero_modal" name="apellido" placeholder="Apellido" required
                                          class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" />
                               </div>
                               <div>
                                   <label for="email_extranjero_modal" class="block mb-2 text-sm font-medium text-gray-900">Email</label>
                                   <input type="email" id="email_extranjero_modal" name="email" placeholder="ejemplo@dominio.com" required
                                          class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" />
                               </div>
                               <div>
                                   <label for="telefono_extranjero_modal" class="block mb-2 text-sm font-medium text-gray-900">Teléfono</label>
                                   <input type="text" id="telefono_extranjero_modal" name="telefono" placeholder="+XX XXXXXXXXX"
                                          class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" />
                               </div>
                               <div>
                                   <label for="nacionalidad_extranjero_modal" class="block mb-2 text-sm font-medium text-gray-900">Nacionalidad</label>
                                   <select id="nacionalidad_extranjero_modal" name="nacionalidad" required
                               ...
                               <div>
                                   <label for="tipo_documento_extranjero_modal" class="block mb-2 text-sm font-medium text-gray-900">Tipo Documento</label>
                                   <select id="tipo_documento_extranjero_modal" name="tipo_documento" required
                                           class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5">
                                        <option value="">Seleccione</option>
                                        <option value="Pasaporte">Pasaporte</option>
                                        <option value="Registro Geral">Registro Geral</option>
                               ...
                               <div>
                                   <label for="numero_documento_extranjero_modal" class="block mb-2 text-sm font-medium text-gray-900">Número Documento</label>
                                   <input type="text" id="numero_documento_extranjero_modal" name="numero_documento" placeholder="Número de Documento" required
                                          class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" />
                               </div>
                           </div>
                           <div class="flex items-center justify-end space-x-2">
                               ...
                               <button type="submit" id="guardar-cliente-extranjero"
           ...
           <script src="js/actualizarClienteExtranjeroModal.js"></script>
